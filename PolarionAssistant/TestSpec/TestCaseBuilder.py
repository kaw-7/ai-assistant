import testspec_config as ts_conf

from polarion.polarion import Polarion

# 1. Connect to Polarion and get your project
client = Polarion('https://your-polarion-url.com/polarion', 'username', 'password')
project = client.getProject('YOUR_PROJECT_ID')

# 2. Get the source and target documents
# Format usually follows: 'space_name/document_name'
val_plan = project.getDocument('Testing/Validation Plan')
test_spec = project.getDocument('Testing/Test Specification')
