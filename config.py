...
REF_PATH = "input/vector_cast_24_gold_standard.txt" #reconstructed_vector_cast_24_gold_standard.csv
...
DOC_NAME = "Validation Report Test"
...
ISSUE_INPUT_FILE = "output/final_risk_report.txt"
